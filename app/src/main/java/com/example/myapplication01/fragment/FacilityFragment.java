...
public class FacilityFragment extends Fragment implements
    ...
    private void initMap(Bundle savedInstanceState,View rootView) {
        mapView = (MapView) rootView.findViewById(R.id.amapView1);
    ...
    private void render(Marker marker, View view) {
        ((ImageView) view.findViewById(R.id.badge))
                .setImageResource(R.drawable.icon_f1);
        //修改InfoWindow标题内容样式
    ...
    public void onInfoWindowClick(Marker marker) {
        DetailDialog dialog=new DetailDialog(getContext(),R.style.DialogTheme,marker.getTitle(),1);
    ...
    private void addMarkersToMap() {
        aMap.addMarker(new MarkerOptions()
                .position(Constants.xinxixuebu2shitang).title("信息学部2食堂")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.xinxixuebu4shitang).title("信息学部4食堂")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.caochang912).title("912操场")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.gongxuebu2shitang).title("工学部二食堂")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.fengyuanshitang).title("枫园食堂")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.xinghuyuanshitang).title("星湖园食堂")
                .snippet("").draggable(false));
    }
}
