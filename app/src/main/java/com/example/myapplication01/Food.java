...
public class Food extends Fragment implements
    ...
    private void initMap(Bundle savedInstanceState,View rootView) {
        mapView = (MapView) rootView.findViewById(R.id.amapView2);
    ...
    private void render(Marker marker, View view) {
        ((ImageView) view.findViewById(R.id.badge))
                .setImageResource(R.drawable.icon_f2);
        //修改InfoWindow标题内容样式
    ...
    public void onInfoWindowClick(Marker marker) {
        DetailDialog dialog=new DetailDialog(getContext(),R.style.DialogTheme,marker.getTitle(),2);
    ...
    private void addMarkersToMap() {
        aMap.addMarker(new MarkerOptions()
                .position(Constants.malxiangguo).title("麻辣香锅")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.xiaolongxia).title("小龙虾")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.roujiamo).title("肉夹馍")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.bingzhenxigua).title("冰镇西瓜")
                .snippet("").draggable(false));
        aMap.addMarker(new MarkerOptions()
                .position(Constants.xiangyinboke).title("香茵波克汉堡")
                .snippet("").draggable(false));
    }
}
